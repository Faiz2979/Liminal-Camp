...
namespace Yarn.Unity
{
    ...
    /// </summary>
    public class LetterTypewriterWithTypingSFX : IAsyncTypewriter
    {
        /// <summary>
        /// The <see cref="TMP_Text"/> to display the text in.
        /// </summary>
        public TMP_Text? Text { get; set; }
        public AudioClip[] typingClips = new AudioClip[2];
        ...
        private void PlayTypingSFX(string text, int index)
        {
            if (audioSource == null || typingClips.Length == 0)
                return;
            ...
            audioSource.pitch = 1f + UnityEngine.Random.Range(
                -PitchRandomRange,
                PitchRandomRange
            );

            audioSource.PlayOneShot(
                typingClips[UnityEngine.Random.Range(0, typingClips.Length)]
            );
        }
